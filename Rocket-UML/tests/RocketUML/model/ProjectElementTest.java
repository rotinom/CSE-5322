...
public class ProjectElementTest {
    ...
    public void testProject(){
        ...
        ClassElement class1 = (ClassElement) ElementCreator.getElement("Class", 0, 0);
        ClassElement base = class1.setName("base");

        ClassElement class2 = (ClassElement) ElementCreator.getElement("Class", 0, 0);
        ...
        RelationshipElement relation = (RelationshipElement) ElementCreator.getElement("Relationship", 0, 0);
        ...
        ClassElement class3 = (ClassElement) ElementCreator.getElement("Class", 0, 0);
